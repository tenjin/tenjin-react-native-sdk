...
export interface Spec extends TurboModule {
    ...
    transactionWithReceipt(productName: string, currencyCode: string, quantity: number, unitPrice: number, transaction: string, data: string): void;
    ...
    updatePostbackConversionValueWithCoarseValue(conversionValue: number, coarseValue: string): void;
    updatePostbackConversionValueWithCoarseValueAndLockWindow(conversionValue: number, coarseValue: string, lockWindow: boolean): void;
    getAttributionInfo(successCallback: (info: JSONObject) => void, errorCallback: (error: string) => void): void;
...
//# sourceMappingURL=NativeTenjin.d.ts.map